          ...
          <div className="profile-page">
            ...
            <div className="profile-container">
              <div className="profile-inner-container">
                {role === "admin" && <h3 className="text-center mb-4">Welcome Administrator</h3>}
                {role === "user" && <h3 className="text-center mb-4">Welcome {facade.getUsername().charAt(0).toUpperCase() + facade.getUsername().slice(1)}</h3>}
              </div>
